...
public class ClassMemberManager extends AbstractManager<AbstractExam, Exam, ExamComplex> {
    private static ClassMemberManager examManager = null;

    public static ClassMemberManager getInstance() {
        if (examManager == null) {
            examManager = new ClassMemberManager();
        }
        return examManager;
    }
